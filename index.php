				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?php echo (empty($_GET['page']) ? 'active': '')?>">
						<a class="sidebar-link" href="index.php"> 
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dasboard</span>
						</a>
					</li>
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
								...
								<img src="foto/<?php echo $_SESSION['user']['foto']?>" class="avatar img-fluid rounded me-1"
									alt="Charles Hall" /> <span class="text-dark"><?php echo $_SESSION['user']['nama'] ?></span>
							</a>
